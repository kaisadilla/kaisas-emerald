...
#define FLAG_FIRST_RIVAL_BATTLE_FOUGHT       0x71 // [Replaced] Indicates whether the player has already fought Rival in Route 3, but hasn't started the adventure yet.
...
#define FLAG_KAISA_ITEM_LITTLEROOT_POTION                           0x493 // Unused Flag
