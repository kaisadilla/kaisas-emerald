static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_PETALBURG_CITY - 1] = {MAP_GROUP(PETALBURG_CITY), MAP_NUM(PETALBURG_CITY), 24, 22},
    ...
    [HEAL_LOCATION_OLDALE_TOWN - 1] = {MAP_GROUP(OLDALE_TOWN), MAP_NUM(OLDALE_TOWN), 26, 29},
    ...
    [HEAL_LOCATION_ROUTE5 - 1] = {MAP_GROUP(ROUTE5), MAP_NUM(ROUTE5), 19, 42},
};
