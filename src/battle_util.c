...
//   normal  fightin wind    poison  ground  rock    bug     ghost   steel   mystery fire    water   grass   electri psychic ice     dragon  dark    fairy   
    ...
    {X(1.0), X(0.5), X(0.5), X(0.5), X(1.0), X(1.0), X(1.0), X(1.0), X(0.5), X(1.0), X(1.0), X(1.0), X(1.0), X(1.0), X(2.0), X(1.0), X(1.0), X(2.0), X(2.0)}, //bug
...
//   normal  fightin wind    poison  ground  rock    bug     ghost   steel   mystery fire    water   grass   electri psychic ice     dragon  dark    fairy   
    ...
    {X(1.0), X(2.0), X(2.0), X(2.0), X(1.0), X(1.0), X(1.0), X(1.0), X(2.0), X(1.0), X(1.0), X(1.0), X(1.0), X(1.0), X(0.5), X(1.0), X(1.0), X(0.5), X(0.5)}, //bug
